...
<section class="tvnl-banner">
    <img src="assets/images/banner/board-banner.jpg" alt="Info Desk - Documents & Reports" title="Info Desk - Documents & Reports"
        class="banner-img img-fluid">
    <div class="banner-overlay">
        <div class="container text-center">
            <h2 class="banner-title">Documents & Reports</h2>
        </div>
    </div>
</section>
