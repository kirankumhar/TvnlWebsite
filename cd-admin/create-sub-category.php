                ...
                <div class="col-md-12">
                    ...
                    <form action="<?= $base_url ?>/src/controllers/SubCategoryController.php" method="post"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="engsubCatName" id="engsubCatName" class="form-control" value="" required>
                        </div>
                        <div class="mb-3">
                            <label for="hinsubCatName" class="form-label">Sub-Category Name (Hindi)</label>
                            <input type="text" name="hinsubCatName" id="hinsubCatName" class="form-control" value="">
                        </div>
