...
<section class="gallery-contant">
    ...
    <div class="photos-gallery-grid">
        <div class="photos-gallery-card">
            <a href="media-coverage-gallery.php">
                <img src="assets/images/gallery/activities/actv1.png" alt="Media Coverage,  TVNL" title="Media Coverage,  TVNL">
                <h5>TVNL is the only government-owned thermal power plant in Jharkhand with an installed capacity.</h5>
            </a>
        </div>
        <div class="photos-gallery-card">
            <a href="media-coverage-gallery.php">
                <img src="assets/images/gallery/activities/news-b.jpg" alt="Media Coverage,  TVNL" title="Media Coverage,  TVNL">
                <h5>TVNL is the only government-owned thermal power plant in Jharkhand with an installed capacity.</h5>
            </a>
        </div>
        <div class="photos-gallery-card">
            <a href="media-coverage-gallery.php">
                <img src="assets/images/gallery/activities/sustainability.jpg" alt="Media Coverage,  TVNL" title="Media Coverage,  TVNL">
                <h5>TVNL is the only government-owned thermal power plant in Jharkhand with an installed capacity.</h5>
            </a>
        </div>
        <div class="photos-gallery-card">
