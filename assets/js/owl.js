...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateFont() {
        ...
        elements.forEach(el => {
            ...
            if (["p","span","li","a","td","th","label","h1","h2","h3","h4","h5","h6"].includes(tag)) {
